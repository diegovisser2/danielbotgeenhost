...
module.exports = {
    ...
    description: 'Het kanaal voor welkoms berichten',
    usage: `welkomkanaal <#kanaal>`,
    run: async (client, message, args) => {
        ...
        if (settings.Engels === true) {
            ...
            const kanaal = await message.mentions.channels.first();
            ...
            await Guild.findOne({
                ...
                if (!guild) {
                    ...
                    const embed = new MessageEmbed()
                        .setColor("GREEN")
                        .setDescription(`✅ The channel for welcome messages is from now ${kanaal}`)
            ...
            await Guild.findOne({
                ...
                if (!guild) {
                    ...
                    const embed = new MessageEmbed()
                        .setColor("GREEN")
                        .setDescription(`✅ Het kanaal voor welkom berichten is vanaf nu ${kanaal}`)
