...
module.exports = {
    ...
    description: 'Het kanaal voor reviews.',
    usage: `reviewkanaal <#kanaal>`,
    run: async (client, message, args) => {
        ...
        if (settings.Engels === true) {
            ...
            const review = await message.mentions.channels.first();
            ...
            await Guild.findOne({
                ...
                if (!guild) {
                    ...
                    const embed = new MessageEmbed()
                        .setColor("GREEN")
                        .setDescription(`✅ The channel for reviews is from now ${review}`)
            ...
            await Guild.findOne({
                ...
                if (!guild) {
                    ...
                    const embed = new MessageEmbed()
                        .setColor("GREEN")
                        .setDescription(`✅ Het kanaal voor reviews is vanaf nu ${review}`)
