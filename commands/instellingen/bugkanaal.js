...
module.exports = {
    ...
    description: 'Het kanaal voor bugs meldingen',
    usage: `bugkanaal <#kanaal>`,
    run: async (client, message, args) => {
        ...
        if (settings.Engels === true) {
            ...
            const bug = await message.mentions.channels.first();
            ...
            await Guild.findOne({
                ...
                if (!guild) {
                    ...
                    const embed = new MessageEmbed()
                        .setColor("GREEN")
                        .setDescription(`✅ The channel for bugs is from now ${bug}`)
            ...
            await Guild.findOne({
                ...
                if (!guild) {
                    ...
                    const embed = new MessageEmbed()
                        .setColor("GREEN")
                        .setDescription(`✅ Het kanaal voor bugs meldingen is vanaf nu ${bug}`)
