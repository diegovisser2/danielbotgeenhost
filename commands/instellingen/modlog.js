...
module.exports = {
    ...
    description: 'Het kanaal voor logs instellen.',
    usage: `modlog <#kanaal>`,
        ...
        if (settings.Engels === true) {
            ...
            await Guild.findOne({
                ...
                if (!guild) {
                    ...
                    const embed = new MessageEmbed()
                        .setColor("GREEN")
                        .setDescription(`✅ From now on the channel for logs is ${channel}`)
            ...
            await Guild.findOne({
                ...
                if (!guild) {
                    ...
                    const embed = new MessageEmbed()
                        .setColor("GREEN")
                        .setDescription(`✅ Het kanaal voor logs is vanaf nu ${channel}`)
